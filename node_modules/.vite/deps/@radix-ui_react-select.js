...
function RemoveScrollSideCar(props) {
  ...
  return React22.createElement(
    ...
    removeScrollBar ? React22.createElement(RemoveScrollBar, { noRelative: props.noRelative, gapMode: props.gapMode }) : null
  );
}
...
var SelectContentImpl = React24.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst2 = React24.useCallback(
      (candidates) => {
    ...
    const handleItemLeave = React24.useCallback(() => content == null ? void 0 : content.focus(), [content]);
