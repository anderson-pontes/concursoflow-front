...
export function CalendarioDiaDetalheDialog({ data, concursoId, open, onClose, onRegistrar }: Props) {
              ...
              <section>
                ...
                <ul className="space-y-2">
                  {detalhe.planejado.map((p) => (
                    <li key={p.id} className="rounded-lg border border-border bg-muted/30 px-3 py-2 text-sm">
